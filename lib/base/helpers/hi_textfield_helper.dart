...
///
class HiTextFieldHelper extends StatefulWidget {
  const HiTextFieldHelper({
    Key? key,
    required this.child,
  ...
  @override
  _HiTextFieldHelperState createState() => new _HiTextFieldHelperState();
}

///
/// We implement the WidgetsBindingObserver to be notified of any change to the window metrics
///
class _HiTextFieldHelperState extends State<HiTextFieldHelper>
