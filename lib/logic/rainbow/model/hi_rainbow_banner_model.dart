...
class HiRainbowBannerModel {
  HiRainbowBannerModel({
    List<HiRainbowBannerSonModel>? data,
    num? errorCode,
    String? errorMsg,
  }) {
    _data = data;
  ...
  HiRainbowBannerModel.fromJson(dynamic json) {
    if (json['data'] != null) {
      _data = [];
      json['data'].forEach((v) {
        _data?.add(HiRainbowBannerSonModel.fromJson(v));
      });
    }
    _errorCode = json['errorCode'];
    _errorMsg = json['errorMsg'];
  }
  List<HiRainbowBannerSonModel>? _data;
  num? _errorCode;
  String? _errorMsg;
  HiRainbowBannerModel copyWith({
    List<HiRainbowBannerSonModel>? data,
    num? errorCode,
    String? errorMsg,
  }) =>
  ...
  List<HiRainbowBannerSonModel>? get data => _data;
...
class HiRainbowBannerSonModel {
  HiRainbowBannerSonModel({
    String? desc,
    num? id,
    String? imagePath,
    num? isVisible,
  ...
  HiRainbowBannerSonModel.fromJson(dynamic json) {
    _desc = json['desc'];
    _id = json['id'];
  ...
  num? _type;
  String? _url;
  HiRainbowBannerSonModel copyWith({
    String? desc,
    num? id,
    String? imagePath,
    num? isVisible,
